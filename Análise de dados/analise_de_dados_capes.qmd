...
![Gráfico de Produção de Teses e Dissertações em Sociologia, por Palavra-Chave (1987-2022)](Produção%20de%20Teses%20e%20Dissertações%20em%20Sociologia,%20por%20Palavra-Chave%20(1987-2022).png)

## 4. Diferenças regionais

Nesta seção, calculei o total de trabalhos defendidos ao longo de todo o período por estado e serão criadas duas visualizações: em uma, reporta a frequência de trabalhos por região; em outra, a frequência de trabalhos por unidade da federação.
...
### Gráficos da frequência de trabalhos
