...
Para carregar a planilha com informações sobre os programas de pós-graduação, usei a função `import()` do pacote `rio`. Essa planilha possui 3 variáveis: código do programa, estado e conceito

CAPES. Cada observação diz respeito a um programa de pós-graduação.
