...
# Filtra apenas as cinco primeiras observa̵̤es do banco capitais
slice(capitais, 1:5)

# Filtra apenas a primeira e a quinta observa̵̤es do banco capitais
...
# Filtra as capitais que gastaram mais de R$ 250 milh̵es em sa̼de e mais de R$ 300 milh̵es em educa̤̣o em 2012
filter(capitais, 
