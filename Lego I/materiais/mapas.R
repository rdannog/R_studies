...
covid <- read_delim("https://raw.githubusercontent.com/Mjrovai/Python4DS/59a6a6651856e6f70fc849410994f1f44278842b/20_Mapping_Covid19_Brazil/data/cases-brazil-cities-5-5-2020.csv",
                    delim = ",")
head(covid)
